...
public class B_ViewDonars extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b__view_donars);

        getSupportActionBar().setTitle("Blood Donation");

        mylistView=(ListView)findViewById(R.id.listView);

        mRef=FirebaseDatabase.getInstance().getReference("Blood");
